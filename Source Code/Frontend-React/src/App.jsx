...
// import LoginWithGoogle from "./pages/Auth/LoginWithGoogle.jsx";
...
dispatch(getUser(localStorage.getItem("jwt")))
  ...
  return (
    <>
      ...
      {auth.user ? (
        <>
        <div className={isDarkMode ?'DarkToggle':'LightToggle'} >
        {showNavbar && <Navbar handleDarkModeToggle={handleDarkModeToggle} />}
         {/* {showNavbar && <Navbar/>} */}
          <Routes>
